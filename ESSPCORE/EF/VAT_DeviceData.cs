...
namespace ESSPCORE.EF
{
    ...
    public partial class VAT_DeviceData
    {
        ...
        public Nullable<byte> ReaderDutyCodeID { get; set; }
        public string IpAdd { get; set; }
        public Nullable<short> IpPort { get; set; }
        public Nullable<byte> RdrTypeID { get; set; }
        public Nullable<bool> ReaderStatus { get; set; }
        public string ReaderDutyName { get; set; }
        public string RdrLocationName { get; set; }
    }
}
