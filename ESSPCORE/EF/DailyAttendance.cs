...
namespace ESSPCORE.EF
{
    ...
    public partial class DailyAttendance
    {
        ...
        public Nullable<int> ALocID { get; set; }
        public Nullable<int> AGradeID { get; set; }
        public Nullable<int> ADesigID { get; set; }
        public Nullable<int> AOUID { get; set; }
        public Nullable<int> AEmpTypeID { get; set; }
